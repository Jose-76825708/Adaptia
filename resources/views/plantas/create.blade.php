    ...
    <main class="flex flex-5 flex-col px-25 py-10 bg-[#fbfbfb] h-full gap-4 overflow-y-auto">
        ...
        <section class="flex justify-center pb-10">
            <div class="flex flex-col p-10 bg-[#fefdfe] rounded-[20px] shadow-xl w-full gap-8 border border-[#ecedea]">
                <form action="{{ route('plantas.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-10">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="nombre" id="nombre"
                                       ...
                                       placeholder="Ej: Monstera Deliciosa" value="{{ old('nombre') }}" required>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="tipo_planta_id" id="tipo_planta_id"
                                    ...
                                    @foreach($tipos as $tipo)
                                        <option value="{{ $tipo->id }}" {{ old('tipo_planta_id') == $tipo->id ? 'selected' : '' }}>{{ $tipo->nombre }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="file" name="imagen" id="imagen"
                                       class="p-3 bg-[#f3f5f3] border-2 @error('imagen') border-red-500 @else border-[#ecedea] @enderror rounded-[10px] outline-none focus:border-[#629f22] transition duration-300 text-[#304e42] file:mr-4 file:py-1 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#629f22] file:text-white hover:file:bg-[#4d7d1a] cursor-pointer" required>
                                @error('imagen') <span class="text-red-500 text-[0.9em] font-medium">{{ $message }}</span> @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="luz_requerida" id="luz_requerida"
                                    ...
                                    <option value="baja" {{ old('luz_requerida') == 'baja' ? 'selected' : '' }}>Baja</option>
                                    <option value="media" {{ old('luz_requerida') == 'media' ? 'selected' : '' }}>Media</option>
                                    <option value="alta" {{ old('luz_requerida') == 'alta' ? 'selected' : '' }}>Alta</option>
                                    <option value="siempre_en_el_sol" {{ old('luz_requerida') == 'siempre_en_el_sol' ? 'selected' : '' }}>Siempre al sol</option>
                                </select>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="tamaño_adulto" id="tamaño_adulto"
                                    ...
                                    <option value="pequena" {{ old('tamaño_adulto') == 'pequena' ? 'selected' : '' }}>Pequeña</option>
                                    <option value="mediana" {{ old('tamaño_adulto') == 'mediana' ? 'selected' : '' }}>Mediana</option>
                                    <option value="grande" {{ old('tamaño_adulto') == 'grande' ? 'selected' : '' }}>Grande</option>
                                </select>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="tipo_ambiente" id="tipo_ambiente"
                                    ...
                                    <option value="interiores" {{ old('tipo_ambiente') == 'interiores' ? 'selected' : '' }}>Interiores</option>
                                    <option value="exteriores" {{ old('tipo_ambiente') == 'exteriores' ? 'selected' : '' }}>Exteriores</option>
                                    <option value="ambos" {{ old('tipo_ambiente') == 'ambos' ? 'selected' : '' }}>Ambos</option>
                                </select>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="frecuencia_riego" id="frecuencia_riego"
                                    ...
                                    <option value="diario" {{ old('frecuencia_riego') == 'diario' ? 'selected' : '' }}>Diario</option>
                                    <option value="cada_3_dias" {{ old('frecuencia_riego') == 'cada_3_dias' ? 'selected' : '' }}>Cada 3 días</option>
                                    <option value="semanal" {{ old('frecuencia_riego') == 'semanal' ? 'selected' : '' }}>Semanal</option>
                                    <option value="quincenal" {{ old('frecuencia_riego') == 'quincenal' ? 'selected' : '' }}>Quincenal</option>
                                    <option value="mensualmente" {{ old('frecuencia_riego') == 'mensualmente' ? 'selected' : '' }}>Mensualmente</option>
                                </select>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="estetica" id="estetica"
                                    ...
                                    <option value="follaje" {{ old('estetica') == 'follaje' ? 'selected' : '' }}>Follaje</option>
                                    <option value="flor" {{ old('estetica') == 'flor' ? 'selected' : '' }}>Flor</option>
                                    <option value="colgantes" {{ old('estetica') == 'colgantes' ? 'selected' : '' }}>Colgantes</option>
                                    <option value="suculentas" {{ old('estetica') == 'suculentas' ? 'selected' : '' }}>Suculenta</option>
                                </select>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="nivel_cuidado" id="nivel_cuidado"
                                    ...
                                    <option value="principiante" {{ old('nivel_cuidado') == 'principiante' ? 'selected' : '' }}>Principiante</option>
                                    <option value="intermedio" {{ old('nivel_cuidado') == 'intermedio' ? 'selected' : '' }}>Intermedio</option>
                                    <option value="experto" {{ old('nivel_cuidado') == 'experto' ? 'selected' : '' }}>Experto</option>
                                </select>
                            ...
                            <div class="flex items-center gap-3 py-4">
                                <input type="checkbox" name="es_toxica" id="es_toxica" value="1"
                                       class="w-6 h-6 accent-[#629f22] cursor-pointer" {{ old('es_toxica') ? 'checked' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="number" name="stock_actual" id="stock_actual"
                                       ...
                                       placeholder="0" value="{{ old('stock_actual') }}" required>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="number" name="stock_minimo" id="stock_minimo"
                                       ...
                                       placeholder="0" value="{{ old('stock_minimo') }}" required>
