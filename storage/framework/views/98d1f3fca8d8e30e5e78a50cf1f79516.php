    ...
    <main class="flex flex-5 flex-col px-25 py-10 bg-[#fbfbfb] h-full gap-4">
        ...
        <section class="flex justify-center">
            <div class="flex flex-col p-10 bg-[#fefdfe] rounded-[20px] shadow-xl w-full max-w-2xl gap-8 border border-[#ecedea]">
                <form action="<?php echo e(route('sensores.update', $sensor->id)); ?>" method="POST" class="flex flex-col gap-6">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300"
                               ...
                               value="<?php echo e(old('identificador_fisico', $sensor->identificador_fisico)); ?>" required>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300">
                            ...
                            <option value="activo" <?php echo e((old('estado') ?? $sensor->estado) == 'activo' ? 'selected' : ''); ?>>Activo</option>
                            <option value="inactivo" <?php echo e((old('estado') ?? $sensor->estado) == 'inactivo' ? 'selected' : ''); ?>>Inactivo</option>
                        </select>
...
</html><?php /**PATH C:\xampp\htdocs\Adaptia\resources\views/sensores/edit.blade.php ENDPATH**/ ?>