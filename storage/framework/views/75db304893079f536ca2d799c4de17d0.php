...
<body class="flex font-sans h-screen">
    ...
    <main class="flex flex-5 flex-col px-25 py-10 bg-[#fbfbfb] h-full gap-4">
        ...
        <section>
            <a class="flex items-center text-[#0c251c] font-bold text-[0.8em]" href="<?php echo e(route('tipoPlantas.index')); ?>">
                <img class="w-[3%] h-auto" src="<?php echo e(asset('images/regreso-flecha.png')); ?>" alt="">Volver a Tipos de Plantas
            </a>
        </section>
