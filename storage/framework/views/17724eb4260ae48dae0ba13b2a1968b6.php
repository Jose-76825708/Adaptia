...
<body class="flex font-sans h-screen bg-[#fbfbfb] items-center justify-center">
    ...
    <div class="flex flex-col p-10 bg-[#fefdfe] rounded-[20px] shadow-xl w-full max-w-md gap-8 border border-[#ecedea]">
        ...
        <div class="flex flex-col items-center text-center gap-2">
            ...
            <h1 class="text-[#103928] font-bold text-[2em]">Iniciar Sesión</h1>
            <p class="text-[#8b8d8f] text-[1em]">Bienvenido de nuevo. Por favor, ingresa tus credenciales.</p>
        </div>

        <form action="<?php echo e(route('login')); ?>" method="POST" class="flex flex-col gap-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center mt-6">
            <p class="text-[#8b8d8f] text-[0.9em]">¿No tienes una cuenta? <a href="<?php echo e(route('register')); ?>" class="text-[#629f22] font-bold hover:underline">Regístrate aquí</a></p>
        </div>
    </div>
