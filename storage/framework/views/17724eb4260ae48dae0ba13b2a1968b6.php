    ...
    <div class="flex flex-col lg:flex-row h-full w-full">
        ...
        <div class="w-full lg:w-1/2 h-full flex items-center justify-center bg-[#fbfbfb] p-6">
            <div class="flex flex-col p-12 bg-[#fefdfe] rounded-[30px] shadow-2xl w-full max-w-2xl gap-10 border border-[#ecedea]">
                ...
                <form action="<?php echo e(route('login')); ?>" method="POST" class="flex flex-col gap-8">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> rounded-[12px] outline-none focus:border-[#629f22] transition duration-300 text-[1.1em]"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center mt-4">
                    <p class="text-[#8b8d8f] text-[1em]">¿No tienes una cuenta? <a href="<?php echo e(route('register')); ?>" class="text-[#103928] font-bold hover:underline">Regístrate aquí</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="hidden lg:flex w-1/2 h-full bg-[#103928] items-center justify-center relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col items-center text-center p-12">
                <img class="w-full max-w-lg h-auto drop-shadow-2xl animate-pulse-slow" src="<?php echo e(asset('images/logotipo_blanco.png')); ?>" alt="Adaptia Logo Blanco">
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\Adaptia\resources\views/auth/login.blade.php ENDPATH**/ ?>