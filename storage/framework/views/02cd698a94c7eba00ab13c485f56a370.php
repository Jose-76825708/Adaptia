...
<body class="flex font-sans h-screen">
    ...
    <main class="flex flex-5 flex-col px-25 py-10 bg-[#fbfbfb] h-full gap-4 overflow-y-auto">
        ...
        <section class="flex items-center justify-between mb-8">
            <div class="flex-4">
                <h1 class="text-[#103928] font-bold text-[2.5em]">Crear Planta</h1>
                <p class="text-[#8b8d8f] text-[1em]">Registra una nueva planta en el catálogo detallando sus requerimientos y stock.</p>
            </div>
        </section>
        ...
        <section class="flex justify-center pb-10">
            <div class="flex flex-col p-10 bg-[#fefdfe] rounded-[20px] shadow-xl w-full gap-8 border border-[#ecedea]">
                <form action="<?php echo e(route('plantas.store')); ?>" method="POST" enctype="multipart/form-data" class="flex flex-col gap-10">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300"
                                       placeholder="Ej: Monstera Deliciosa" value="<?php echo e(old('nombre')); ?>" required>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300" required>
                                    ...
                                    <?php $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tipo->id); ?>" <?php echo e(old('tipo_planta_id') == $tipo->id ? 'selected' : ''); ?>><?php echo e($tipo->nombre); ?></option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex flex-col gap-2">
                                <label for="imagen" class="text-[#304e42] font-semibold text-[1.1em]">Imagen de la Planta</label>
                                <input type="file" name="imagen" id="imagen"
                                       class="p-3 bg-[#f3f5f3] border-2 <?php $__errorArgs = ['imagen'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-[#ecedea] <?php unset($message);
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300 text-[#304e42] file:mr-4 file:py-1 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#629f22] file:text-white hover:file:bg-[#4d7d1a] cursor-pointer" required>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300"
                                       placeholder="0.00" value="<?php echo e(old('precio')); ?>" required>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300" required>
                                    ...
                                    <option value="baja" <?php echo e(old('luz_requerida') == 'baja' ? 'selected' : ''); ?>>Baja</option>
                                    <option value="media" <?php echo e(old('luz_requerida') == 'media' ? 'selected' : ''); ?>>Media</option>
                                    <option value="alta" <?php echo e(old('luz_requerida') == 'alta' ? 'selected' : ''); ?>>Alta</option>
                                    <option value="siempre_en_el_sol" <?php echo e(old('luz_requerida') == 'siempre_en_el_sol' ? 'selected' : ''); ?>>Siempre al sol</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex flex-col gap-2">
                                <label for="tamaño_adulto" class="text-[#304e42] font-semibold text-[1.1em]">Tamaño de Adulto</label>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300" required>
                                    ...
                                    <option value="pequena" <?php echo e(old('tamaño_adulto') == 'pequena' ? 'selected' : ''); ?>>Pequeña</option>
                                    <option value="mediana" <?php echo e(old('tamaño_adulto') == 'mediana' ? 'selected' : ''); ?>>Mediana</option>
                                    <option value="grande" <?php echo e(old('tamaño_adulto') == 'grande' ? 'selected' : ''); ?>>Grande</option>
                                </select>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300" required>
                                    ...
                                    <option value="interiores" <?php echo e(old('tipo_ambiente') == 'interiores' ? 'selected' : ''); ?>>Interiores</option>
                                    <option value="exteriores" <?php echo e(old('tipo_ambiente') == 'exteriores' ? 'selected' : ''); ?>>Exteriores</option>
                                    <option value="ambos" <?php echo e(old('tipo_ambiente') == 'ambos' ? 'selected' : ''); ?>>Ambos</option>
                                </select>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300" required>
                                    ...
                                    <option value="diario" <?php echo e(old('frecuencia_riego') == 'diario' ? 'selected' : ''); ?>>Diario</option>
                                    <option value="cada_3_dias" <?php echo e(old('frecuencia_riego') == 'cada_3_dias' ? 'selected' : ''); ?>>Cada 3 días</option>
                                    <option value="semanal" <?php echo e(old('frecuencia_riego') == 'semanal' ? 'selected' : ''); ?>>Semanal</option>
                                    <option value="quincenal" <?php echo e(old('frecuencia_riego') == 'quincenal' ? 'selected' : ''); ?>>Quincenal</option>
                                    <option value="mensualmente" <?php echo e(old('frecuencia_riego') == 'mensualmente' ? 'selected' : ''); ?>>Mensualmente</option>
                                </select>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300" required>
                                    ...
                                    <option value="follaje" <?php echo e(old('estetica') == 'follaje' ? 'selected' : ''); ?>>Follaje</option>
                                    <option value="flor" <?php echo e(old('estetica') == 'flor' ? 'selected' : ''); ?>>Flor</option>
                                    <option value="colgantes" <?php echo e(old('estetica') == 'colgantes' ? 'selected' : ''); ?>>Colgantes</option>
                                    <option value="suculentas" <?php echo e(old('estetica') == 'suculentas' ? 'selected' : ''); ?>>Suculenta</option>
                                </select>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300" required>
                                    ...
                                    <option value="principiante" <?php echo e(old('nivel_cuidado') == 'principiante' ? 'selected' : ''); ?>>Principiante</option>
                                    <option value="intermedio" <?php echo e(old('nivel_cuidado') == 'intermedio' ? 'selected' : ''); ?>>Intermedio</option>
                                    <option value="experto" <?php echo e(old('nivel_cuidado') == 'experto' ? 'selected' : ''); ?>>Experto</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex items-center gap-3 py-4">
                                <input type="checkbox" name="es_toxica" id="es_toxica" value="1"
                                       class="w-6 h-6 accent-[#629f22] cursor-pointer" <?php echo e(old('es_toxica') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300"
                                       placeholder="0" value="<?php echo e(old('stock_actual')); ?>" required>
...
unset($__errorArgs, $__bag); ?> rounded-[10px] outline-none focus:border-[#629f22] transition duration-300"
                                       placeholder="0" value="<?php echo e(old('stock_minimo')); ?>" required>
...
<?php /**PATH C:\xampp\htdocs\Adaptia\resources\views/plantas/create.blade.php ENDPATH**/ ?>